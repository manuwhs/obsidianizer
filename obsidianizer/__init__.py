...
tests_data_path = os.path.dirname(__file__) + "/../tests/data/"

JOURNALS_PATH = tests_data_path + "journal/"
...
EXAMPLE_VAULT_PATH = VAULTS_PATH + "Journal_vault/"

EXAMPLE_VAULT_NIETZSCHE_PATH = VAULTS_PATH + "Nietzsche/"
EXAMPLE_VAULT_SAVE_TO__PATH = VAULTS_PATH + "Nietzsche2/"
